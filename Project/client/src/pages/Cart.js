                  ...
                  <td className="col-4">
                    <div className="d-flex row row-cols-2 h-50 col-12">
                      <div className=" col-5 h-50 ">
                        <img
                          className=" col-12"
                          src="https://projectgofishing.blob.core.windows.net/gofishing/download.jpg?sv=2021-04-10&ss=bf&srt=co&se=2022-09-27T00%3A58%3A44Z&sp=rwl&sig=s32CK%2FSg5g3Lp25i%2F8B00SRuLu9xxtyf1YjEuI8u4ew%3D"
                        />
                      </div>
                      <div className=" col-7">
